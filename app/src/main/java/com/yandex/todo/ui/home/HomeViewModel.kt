...
import com.yandex.todo.data.api.model.task.TasksFilterType
...
//        }
    ...
    fun loadTasks(forceUpdate: Boolean) {
        ...
        viewModelScope.launch {
            ...
            if (tasksResult is BaseResult.Success) {
                ...
                for (task in tasks) {
                    when (_currentFiltering) {
                        ...
                        TasksFilterType.ACTIVE_TASKS -> if (task.isDone) {
                            tasksToShow.add(task)
                        }
                    }
                }
                isDataLoadingError.value = false
//                _items.value = fillArray()
            } else {
                isDataLoadingError.value = false
//                _items.value = fillArray()
